    ...
    >
      ...
      <div className="container mx-auto flex flex-col-reverse sm:flex-col md:flex-row items-center justify-between w-full">
        ...
        <div className="text-center md:text-left md:w-1/2 max-w-full px-4 mt-6 md:mt-0">
          <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold whitespace-nowrap mb-4 sm:mb-4"
              style={{ fontFamily:'eb-garamond', fontWeight:'700', lineHeight:'62px', letterSpacing:'0%',fontSize:'48px' }}>
            10023 Consultations Done
          </h1>
          <p className="text-sm sm:text-base md:text-lg lg:text-xl font-semibold mb-6 sm:mb-6"
             style={{ fontFamily:'Poppins', fontWeight:'700' }}>
            Your's might be waiting
          </p>
          <Link href="https://play.google.com/store/apps/details?id=com.sobhagya.sobhagya&hl=en">
            <button className="bg-white text-[#F7971D] px-8 sm:px-8 py-3 font-semibold hover:bg-orange-100 transition-colors mb-12 sm:mb-6 md:mb-0"
              style={{
                width: '100%',
                maxWidth: '280px',
                height: '66px',
