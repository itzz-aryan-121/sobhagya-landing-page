  ...
  return (
    <section className="bg-white text-gray-800">
      ...
      <div className="max-w-5xl mx-auto text-center px-6 text-left mt-8">
        <h3 className="text-3xl md:text-4xl font-bold text-[#745802]">
          Introduction
        </h3>
      ...
      <div className="max-w-6xl mx-auto mt-10 flex flex-col md:flex-row items-center px-6 gap-8">
        {/* Features List */}
        <div className="w-full md:w-2/3">
          <h3 className="text-2xl font-bold mb-4">Key Features of Sobhagya:</h3>
