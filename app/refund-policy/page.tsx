    ...
    <div className="flex justify-center items-center min-h-screen bg-gray-100 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl w-full bg-white shadow-lg rounded-2xl p-6 sm:p-8 md:p-10 text-gray-800 mt-5 mb-5 relative">
        ...
        <section className="mb-6 sm:mb-8">
          ...
          <p className="text-sm sm:text-base">
            Return, refund, or exchange requests will be evaluated based on the conditions below:
          </p>
          <div className="mt-3 sm:mt-4 space-y-3">
            <div>
              <h3 className="text-base sm:text-lg font-medium text-orange-700">Eligibility</h3>
              <p className="text-sm sm:text-base">
                Returns or exchanges are only accepted for orders damaged during transit or if an incorrect product was received. Videographic proof is required.
              </p>
            </div>
            <div>
              <h3 className="text-base sm:text-lg font-medium text-orange-700">Timeframe</h3>
              <p className="text-sm sm:text-base">
                Requests must be made within <span className="font-semibold">7 days</span> of receiving the product. The item must be returned in its original condition.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-6 sm:mb-8">
          <h2 className="text-lg sm:text-xl md:text-2xl font-semibold mb-2 sm:mb-3 text-orange-700">Non-Returnable Categories</h2>
        ...
        <section className="mb-6 sm:mb-8">
          <h2 className="text-lg sm:text-xl md:text-2xl font-semibold mb-2 sm:mb-3 text-orange-700">Refund Process</h2>
          <p className="text-sm sm:text-base">
        ...
        <section className="mb-6 sm:mb-8">
          <h2 className="text-lg sm:text-xl md:text-2xl font-semibold mb-2 sm:mb-3 text-orange-700">Cancellation Policy</h2>
          <p className="text-sm sm:text-base">
        ...
        <section className="mb-6 sm:mb-8">
          <h2 className="text-lg sm:text-xl md:text-2xl font-semibold mb-2 sm:mb-3 text-orange-700">Late or Missing Refunds</h2>
          <p className="text-sm sm:text-base">
        ...
        <section className="mb-6 sm:mb-8">
          <h2 className="text-lg sm:text-xl md:text-2xl font-semibold mb-2 sm:mb-3 text-orange-700">Sale Items</h2>
          <p className="text-sm sm:text-base">
        ...
        <section>
          ...
          <p className="text-sm sm:text-base">
            Refunds for international orders will be processed within <span className="font-semibold">40-45 days</span> in case of a delivery issue.
          </p>
          <p className="mt-4">
